...
function process( auth, options, callback) {
  ...
  // sing the headers
  if(options.auth === undefined && auth.tenancyId !== undefined)  // added by kdh (20.12.01)
...
//https://github.com/joyent/node-http-signature/issues/81
  httpSignature.sign( request, 
    { key: auth.privateKey, passphrase:auth.passphrase,
...
function handleResponse( callback ) {
  return function(response) {
    ...
    response.on( 'data', function(chunk) { 
      if( contentType == 'application/json' || contentType == 'application/vnd.com.oracle.oraclecloud.metering.cloudbucks+json')
        JSONBody += chunk; 
    ...
    response.on( 'end', function() {
      ...
      else if ( ( contentType == 'application/json' || contentType == 'application/vnd.com.oracle.oraclecloud.metering.cloudbucks+json' ) && JSONBody != '' ) {
